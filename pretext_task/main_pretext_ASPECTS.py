...
# ################################################################################################################ generator Unet, multiclass for the ASPECTS zones
...
# training
from train_pretext_aspects import train_net
generator = train_net(train_loader, train_ds, val_loader, outdir, num_epoch=num_epoch, lr=lr, wd=wd)
