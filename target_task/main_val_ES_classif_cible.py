...
# loading the weights of the pretext task
state_dict = torch.load(poids, map_location=lambda storage, loc: storage)
...
# launch training
from train_generator_val_ES_classif_cible import train_net
generator = train_net(train_loader, train_ds, val_loader, outdir, state_dict, patience=patience, num_epoch=num_epoch, lr=lr, wd=wd, delta=delta)
